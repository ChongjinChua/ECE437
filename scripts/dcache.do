...
add wave -noupdate -expand -subitemconfig {/dcache_tb/DUT/dc.ds -expand} /dcache_tb/DUT/dc
add wave -noupdate -group dcif /dcache_tb/dcif/halt
add wave -noupdate -group dcif /dcache_tb/dcif/ihit
add wave -noupdate -group dcif /dcache_tb/dcif/imemREN
add wave -noupdate -group dcif /dcache_tb/dcif/imemload
add wave -noupdate -group dcif /dcache_tb/dcif/imemaddr
add wave -noupdate -group dcif /dcache_tb/dcif/dhit
add wave -noupdate -group dcif /dcache_tb/dcif/datomic
add wave -noupdate -group dcif /dcache_tb/dcif/dmemREN
add wave -noupdate -group dcif /dcache_tb/dcif/dmemWEN
add wave -noupdate -group dcif /dcache_tb/dcif/flushed
add wave -noupdate -group dcif /dcache_tb/dcif/dmemload
add wave -noupdate -group dcif /dcache_tb/dcif/dmemstore
add wave -noupdate -group dcif /dcache_tb/dcif/dmemaddr
...
add wave -noupdate /dcache_tb/DUT/hitcount
add wave -noupdate /dcache_tb/DUT/next_hitcount
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {743 ns} 0}
